...
const navigation = [
  ...
  { name: "Albums", href: "/admin/albums", icon: FolderOpen, primary: false }, // Secondary
  { name: "Sections", href: "/admin/sections", icon: Section, primary: false }, // Secondary
  { name: "Gallery", href: "/", icon: Image, primary: false }, // Secondary
];
